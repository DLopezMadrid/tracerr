...
void RenderScene(const std::string& text_proto){
  SceneManager sm;
  sm.LoadScene(text_proto);
}
void GenerateExample(const std::string& text_proto){
  SceneManager sm;
  sm.SaveExampleScene(text_proto);
}
void GenerateTemplate(const std::string& text_proto){
  SceneManager sm;
  sm.LoadScene(text_proto);
}
void GenerateTemplateNoComment(const std::string& text_proto){
  SceneManager sm;
  sm.LoadScene(text_proto);
}
